 ...
 * @author xingfei
 */
public class ThreadPoolMonitorable extends ThreadPoolExecutor {

    private static final Logger LOGGER = LoggerFactory.getLogger(ThreadPoolMonitorable.class);
     ...
     */
    public ThreadPoolMonitorable(int corePoolSize, int maximumPoolSize, long keepAliveTime,
    ...
    public static ExecutorService newFixedThreadPool(int nThreads, String poolName) {
        return new ThreadPoolMonitorable(nThreads, nThreads, 0L, TimeUnit.MILLISECONDS, new LinkedBlockingQueue<>(), poolName);
    }
    ...
    public static ExecutorService newCachedThreadPool(String poolName) {
        return new ThreadPoolMonitorable(0, Integer.MAX_VALUE, 60L, TimeUnit.SECONDS, new SynchronousQueue<>(), poolName);
    }
