package com.xfc.kafka.producer;


import com.alibaba.fastjson.JSON;
import com.xfc.kafka.model.Order;
...
public class MyProducer {
    private final static String TOPIC_NAME = "demo3";

    public static void main(String[] args) throws InterruptedException, ExecutionException {
        Properties props = new Properties();
        props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "192.168.1.129:9092");
         /*
         发出消息持久化机制参数
